export * as ChannelBlendMethods from "~/draw/blender/ChannelBlendMethods.ts";
export * as ColorBlendMethods from "~/draw/blender/ColorBlendMethods.ts";
export * as CompositeMethods from "~/draw/blender/CompositeMethods.ts";
export * as utils from "~/draw/blender/util.ts";
...
export class Blender {
    ...
    blend(image: ImageData, dx: number, dy: number, method: BlendMethod) {
